...
void ARPGGameCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent) {
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ARPGGameCharacter::OnResetVR);
}


void ARPGGameCharacter::OnResetVR() {
	// If RPGGame is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in RPGGame.Build.cs is not automatically propagated
